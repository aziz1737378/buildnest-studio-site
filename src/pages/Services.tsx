    ...
    <>
      ...
      <ScrollAnimatedDiv animation="scroll-fade-in">
        <section className="pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                 <ScrollAnimatedDiv 
                   ...
                   threshold={0.2}
                 >
                   <Card className="group hover-lift h-full overflow-hidden border-2 hover:border-primary/20 transition-all duration-500">
          ...
          {/* CTA Section */}
          <ScrollAnimatedDiv animation="scroll-scale" className="text-center mt-16 relative" threshold={0.3}>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <ScrollAnimatedDiv animation="scroll-slide-left">
                    <Button variant="premium" size="lg" asChild className="hover:scale-105 transition-all duration-300 group shadow-lg hover:shadow-xl">
                  ...
                  <ScrollAnimatedDiv animation="scroll-slide-right">
                    <Button variant="outline" size="lg" asChild className="hover:scale-105 transition-all duration-300 border-2 hover:border-primary/50 hover:bg-primary/5">
